<%@page import="sqa.model.DoiTuongBaoHiem"%>
...
<%
	...
	if(khachHang.getTenDangNhap() == null){
		...
		ArrayList<HopDong> danhSachHopDong =(ArrayList) session.getAttribute("danhSachHopDong");
		HopDong hopDong = proceduce.getHopDong(danhSachHopDong.get(Integer.parseInt(id)));
%>
<body>
	<div style="width: 100%">
		<div
			...
			<div class="main">
				...
				<div class="row" style="width: 100%">
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 infolabel">
						<label>Mã hồ sơ: <%=hopDong.getMaHopDong() %></label>
					</div>
				</div>
				<br> &nbsp;
				<br>
				<div class="row" style="width: 100%">
					<div class="col-xs-7 col-sm-7 col-md-7 col-lg-7 infolabel">
						<label>Người lập hồ sơ: <%= khachHang.getTenKhachHang() %></label>
					</div>
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 infolabel">
						<label>Giới tính:<%=(khachHang.getGioiTinh()==1?"Nam":"Nữ") %> </label>
					</div>
				</div>
				<div class="row" style="width: 100%">
					<div class="col-xs-5 col-sm-5 col-md-5 col-lg-5 infolabel">
						<label>Ngày sinh: <%=khachHang.getNgaySinh() %></label>
					</div>
					<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 infolabel">
						<label>Quốc tịch: Việt Nam</label>
					</div>
					<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 infolabel">
						<label> Dân tộc: Kinh </label>
					</div>
				</div>
				<div class="row" style="width: 100%">
					<div class="col infolabel">
						<label>Địa chỉ thưởng trú: <%=khachHang.getDiaChi() %></label>
					</div>
				</div>
				<div class="row" style="width: 100%">
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 infolabel">
						<label>Số điện thoại: <%=khachHang.getSoDienThoai() %></label>
					</div>
					<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 infolabel">
				...
				<%for(DoiTuongBaoHiem temp : hopDong.getDanhSachBaoHiem()){ %>
					<div class="row" style="width: 100%">
						<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 celltable">
							<label><%=hopDong.getDanhSachBaoHiem().indexOf(temp) %></label>
						</div>
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 celltable">
							<label><%= temp.getTen() %></label>
						</div>
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 celltable">
							<label><%= temp.getNgaySinh() %></label>
						</div>
						<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 celltable">
							<label><%=(temp.getGioiTinh()==1?"Nam":"Nữ") %></label>
						</div>
						<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 celltable">
							<label>Kinh</label>
						</div>
						<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 celltable">
							<label><%= temp.getCmnd() %></label>
						</div>
						<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 celltable">
							<label><%=temp.getLoaiDoiTuong() %></label>
						</div>
						<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 celltable">
							<label><%=temp.getSoTienBaoHiem() * temp.getChietKhau() %></label>
						</div>
						<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 celltable">
